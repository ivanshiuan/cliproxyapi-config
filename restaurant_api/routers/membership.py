...
async def broadcast_segment(
    ...
    # Inject the messenger via the DI seam (rather than letting the service reach
    # for the global singleton) so the override applies consistently — same shape
    # as the campaigns/spin path.
