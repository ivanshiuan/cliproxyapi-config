...
| D6 | 單店 `monthly_pool_budget` = **NT$3,000/月**（保守起手，先驗機制黏著） | Ivan |
| D7 | 帝王雞達標真錢獎金 = **NT$3,000**；因 = 月池，**同月最多 1 人兌現，多人達標排隊至下月**（帝王雞本應稀缺） | Ivan + PM 註記 |
...
獎勵池支出（上限，採 D6 拍板值）：
  monthly_pool_budget    = NT$3,000 / 月  → 36,000 / 年
  淨 ROI                 ≈ 108,000 − 36,000 = +72,000 / 年（且尚未計訓練/服務品質提升）
```
> 結論：只要能**少走 0.8 人/年**就回本（門檻較 6,000 池更穩）。pilot 的核心就是驗證這條因果。**真實數字請用店家 HR 資料替換**。
>
> ⚠️ **池=帝王獎金的張力（D7）**：月池 3,000 = 帝王雞獎金 3,000 → 同月只夠 1 人兌現帝王雞。
> 這對 pilot 是健康的稀缺設計，但**多人同月達標時須排隊至下月發放**——此規則寫入兌換流程（見附錄 B），
> 並在員工 onboarding 講清楚，避免「明明達標卻沒拿到」的誤會。金蛋小額兌現（≈NT$500）一樣受同一月池上限約束。
...
**已拍板（見決策日誌 D6–D9）**
1. ~~獎勵池預算~~ → **NT$3,000/月**（D6）
3. ~~帝王雞獎金~~ → **NT$3,000**，門檻 3 金蛋+全勤；同月限 1 人、多人排隊（D7）
...
- 大雞：累積 1 金蛋等值 + 健康 ≥ 70
- 帝王雞：累積 3 金蛋等值 + 當月全勤 → **真錢 NT$3,000（D7，審核；同月限 1 人，多人排隊次月）**
...
- 因 3,000 池 = 3,000 帝王獎金，同月多人達標時**第 2 人起一律排隊**；FIFO 依 `created_at`。
