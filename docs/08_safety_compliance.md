...
### 1.6 從業人員健康與講習（營運中持續義務）

開店前的健檢/講習在 `docs/19 §7 C 群`；**營運中**這兩項是**持續義務**，別只做一次：
- **每年定期健康檢查**：從業人員依 GHP 每年複檢（A肝/肺結核胸部X光/傷寒等），結果留存備查；新進者先體格檢查合格才上工。
- **負責人/衛生管理人員食安講習**：定期更新；一定規模以上須設**專任食品安全管制人員**。
- 患有 GHP 所列不適合從事食品工作之疾病者，不得從事與食品直接接觸之工作。

> 落地門檻（講習時數、健檢項目、管制人員設置規模）各地方衛生局略有差異，依當地公告。
